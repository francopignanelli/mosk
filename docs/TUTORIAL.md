...
New terrain contains fewer spiders. Only one spider pursues at a time, with an eight-second chase/search budget followed by twelve seconds without a new pursuit. Nearby non-pursuers move away to open an escape route. Contact still causes damage, and the fly still senses actual spider positions. Health repairs slowly during rest with adequate reserves and no bite. A successful fly can stay at 100%. See [resource lifecycle](./RESOURCE_LIFECYCLE.md) and [predator encounters](./PREDATOR_ENCOUNTERS.md) for the rules, continuity checks and scientific limits.
